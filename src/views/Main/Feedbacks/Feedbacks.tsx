...
export const fakePostsData: DataType[] = [
  {
    id: '1',
    title: 'Обратная связь 1',
    description: 'Описание обратной связи 1',
  },
  {
    id: '2',
    title: 'Обратная связь 2',
    description: 'Описание обратной связи 2',
  },
  {
    id: '3',
    title: 'Обратная связь 3',
    description: 'Описание обратной связи 3',
  },
  {
    id: '4',
    title: 'Обратная связь 4',
    description: 'Описание обратной связи 4',
  },
  {
    id: '5',
    title: 'Обратная связь 5',
    description: 'Описание обратной связи 5',
  },
];
      ...
      <List
        ...
        >
          <Skeleton avatar title={false} loading={false} active>
            <List.Item.Meta
              title={<Link to={`${LINKS.FEEDBACKS.path}/${item.id}`}> {item.title}</Link>}
